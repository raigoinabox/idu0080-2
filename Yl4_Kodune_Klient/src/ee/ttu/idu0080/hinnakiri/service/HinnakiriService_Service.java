...
@WebServiceClient(name = "HinnakiriService", 
                  wsdlLocation = "http://localhost:8080/Yl4_Kodune_Server/services/HinnakiriPort?wsdl",
...
public class HinnakiriService_Service extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8080/Yl4_Kodune_Server/services/HinnakiriPort?wsdl");
